...
export default function TemporaryDrawer({
  ...
  useEffect(() => {
    // Update initialY or perform other actions based on scrollY
    // ...
  }, [scrollY]);
    ...
    <div>
      <React.Fragment>
        <SwipeableDrawer
          ...
          onOpen={toggleDrawer1("bottom", true,"tracker",handleTechAndDiagram,searchHighlight,handleSearch)}
          sx={{
          zIndex: "999999999999",
          }}
        ...
        >
          ...
          <div className={styles.second_section_text} style={{background:bgColor}}>
            ...
            {searchHighlight !=oldsearchHistory?  <div
