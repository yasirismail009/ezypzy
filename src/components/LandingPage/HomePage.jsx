  ...
  return (
    <div className={styles.main_div}>
        <div className={styles.flexData}>
         ...
         <div className={styles.btn} onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>{isHovered?<svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 50 44" fill="none">
